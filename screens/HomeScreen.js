  ...
  const [allUnis, setAllUnis] = useState([
    {
      ...
      uniInformation: "Ukrainian Catholic University (UCU) is a private higher education institution located in Lviv. Established in 2002, UCU is the successor of the Lviv Theological Academy and has a unique philosophical and Christian orientation. The university is known for its emphasis on ethics, leadership, civic responsibility, and critical thinking. UCU includes faculties of humanities, applied sciences, social sciences, and theology. The campus is modern and open, featuring new academic buildings, a library, a student residence, and an innovation center. UCU actively cooperates with European and American universities. Special focus is placed on forming the next generation of leaders. It is one of the most dynamic universities in Ukraine.",
      uniContent: [
    ...
    },
    {
      ...
      uniInformation: "The National University of Kyiv-Mohyla Academy (NaUKMA) is one of the oldest universities in Ukraine, located in central Kyiv. Founded in 1615, it was the first higher education institution in Eastern Europe modeled after European standards. The modern Academy was reestablished in 1991 as an independent liberal arts and social sciences university. NaUKMA is distinguished by its interdisciplinary education, strong academic integrity policies, and instruction in English. The university offers robust programs in law, sociology, economics, cultural studies, and political science. The academic process emphasizes an individual-centered approach and integration with the European educational space. The campus includes historical buildings that are architectural monuments. NaUKMA serves as a significant intellectual and cultural hub in Ukraine.",
      uniContent: [
        require("../assets/queens-university-belfast-adobestock-525837958.jpg"),
        require("../assets/queens-university-belfast-adobestock-525837958.jpg"),
        require("../assets/queens-university-belfast-adobestock-525837958.jpg"),
